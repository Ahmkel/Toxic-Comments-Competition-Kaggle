...
from tensorflow.python.keras.layers import Input, Dense, Conv2D, MaxPool2D, Flatten, Concatenate, Reshape, Embedding, Dropout


class ComplexConvModel(BaseModel):
    def __init__(self, config, word_index):
        super(ComplexConvModel, self).__init__(config)
    ...
    def build_model(self):
        ...
        self.channel0_final = self.n_grams_channel(self.channel_inputs, 2)
